		...
		<IonApp>
			...
			<IonContent>
				<div className="privacy">
					...
					Der Schutz Ihrer Daten liegt uns besonders am Herzen. Darum geben wir alles, um
					ihre persönlichen Daten bestmöglich zu schützen. Die folgenden Hinweise geben
					Ihnen deshalb zunächst einmal einen einfachen Überblick darüber, was mit Ihren
					...
					Ausführlichere Informationen zum Thema Datenschutz können Sie unserer unter
					diesem Text aufgeführten Datenschutzerklärung entnehmen. Datenerfassung auf
					unserer Website Wer ist verantwortlich für die Datenerfassung auf dieser
					...
					oder der nachfolgenden Datenschutzerklärung entnehmen.
					<br />
					...
					Datenschutz Wir als Betreiber dieser Seite nehmen den Schutz Ihrer persönlichen
					...
					auch, wie und zu welchem Zweck das geschieht. Wir weisen darauf hin, dass die
					...
					Zugriff durch Dritte ist nicht möglich. Rechtsgrundlage der Datenverarbeitung Um
					Ihnen unsere Internetseite und die damit verbundenen Dienstleistungen anbieten
					zu können, müssen wir personenbezogenen Daten verarbeiten. Diese Verarbeitung
					basiert auf folgender Rechtsgrundlage: Art. 6 Abs. 1 lit. a DS-GVO dient als
					Rechtsgrundlage für Verarbeitungsvorgänge, bei denen eine Einwilligung für den
					spezifischen Verwendungszweck eingeholt wird. Handelt es sich bei den zu
					verarbeitenden Daten um personenbezogene Daten die für die Erfüllung eines
					Vertrags erforderlich sind, bei dem Sie selbst Vertragspartei sind, beruht die
					...
					gilt für Verarbeitungsvorgänge die für die Durchführung vorvertraglicher
					Maßnahmen benötigt werden, z.B. bei Produktanfragen. Die Verarbeitung von
					personenbezogenen Daten kann auch aufgrund rechtlicher Verpflichtungen
					erforderlich werden, z.B. zur Erfüllung von steuerlichen Pflichten. Diese Art
					der Datenverarbeitung beruht auf Art. 6 Abs. 1 lit. c DS-GVO In Ausnahmefällen
					kann die Verarbeitung von personenbezogenen Daten notwendig werden, um
					lebenswichtige Interessen der betroffenen Person oder anderer natürlicher
					Personen zu wahren. Dies ist z.B. bei Unfällen im Betrieb notwendig, wenn
					medizinische Hilfe hinzugezogen wird. Die rechtliche Grundlage ergibt sich aus
					Art. 6 Abs. 1 lit. d DS-GVO Personenbezogene Daten können auch auf Basis einer
					Interessenabwägung verarbeitet werden. Dies ist gemäß Art. 6 Abs. 1 lit. f
					DS-GVO dann möglich, wenn ein berechtigtes Interesse seitens unseres
					Unternehmens oder eines Dritten besteht und die Datenverarbeitung dafür zwingend
					erforderlich ist. Dabei darf das berechtigte Interesse die Grundrechte und
					Grundfreiheiten des Betroffenen nicht überwiegen. Widerruf Ihrer Einwilligung
					zur Datenverarbeitung Viele Datenverarbeitungsvorgänge sind nur mit Ihrer
					...
					Datenverarbeitung bleibt vom Widerruf unberührt. Widerspruchsrecht gegen die
					...
					Sie widersprechen, werden Ihre personenbezogenen Daten anschließend nicht mehr
					zum Zwecke der Direktwerbung verwendet (Widerspruch nach Art. 21 Abs. 2 DSGVO).
					Beschwerderecht bei der zuständigen Aufsichtsbehörde Im Falle von Verstößen
					...
					oder gerichtlicher Rechtsbehelfe. Recht auf Datenübertragbarkeit Sie haben das
					...
					nur, soweit es technisch machbar ist. SSL- bzw. TLS-Verschlüsselung Diese Seite
					...
					uns übermitteln, nicht von Dritten mitgelesen werden. Auskunft, Sperrung,
					Löschung und Berichtigung ie haben im Rahmen der geltenden gesetzlichen
					...
					angegebenen Adresse an uns wenden. Recht auf Einschränkung der Verarbeitung. Sie
					...
					verarbeitet werden. Dauer der Speicherung von personenbezogenen Daten Die bei
					uns gespeicherten Daten werden gelöscht, sobald sie für ihre Zweckbestimmung
					nicht mehr erforderlich sind. Ein Erfordernis kann insbesondere dann bestehen,
					wenn die Daten noch benötigt werden, um vertragliche Leistungen zu erfüllen,
					Gewährleistungs- und ggf. Garantiansprüche zu xprüfen und gewähren oder abwehren
					zu können. Im Falle von gesetzlichen Aufbewahrungspflichten kommt eine Löschung
					erst nach Ablauf der jeweiligen Aufbewahrungsfrist in Betracht. Nach
					gesetzlichen Vorgaben erfolgt die Aufbewahrung von Daten für 6 Jahre gemäß §257
					Abs. 1 HGB (Handelsbücher, Inventare, Eröffnungsbilanzen, Jahresabschlüsse,
					Handelsbriefe, Buchungsbelege, etc.) sowie für 10 Jahre gemäß §147 Abs. 1 AO
					(Bücher, Aufzeichnungen, Lageberichte, Buchungsbelege, Handels- und
					Geschäftsbriefe, für Besteuerung relevante Unterlagen, etc.). Widerspruch gegen
					Werbe-E-Mails Der Nutzung von im Rahmen der Impressumspflicht veröffentlichten
					...
					Zusendung von Werbeinformationen, etwa durch Spam-E-Mails, vor. Weitergabe von
					Daten an Dritte Wir geben Ihre persönlichen Daten nur an Dritte weiter, wenn:
					Sie der Weitergabe der Daten ausdrücklich zugestimmt haben (vgl. Art. 6 Abs. 1
					lit. a DS-GVO) Die Weitergabe der Daten für die Abwicklung von
					Vertragsverhältnissen erforderlich ist (vgl. Art. 6 Abs. 1 lit. b DS-GVO) Die
					Weitergabe der Daten für gesetzliche Verpflichtungen notwendig ist (vgl. Art. 6
					Abs. 1 lit. c DS-GVO) Lebenswichtige Interessen von Ihnen oder anderen Personen
					geschützt werden müssen. (vgl. Art. 6 Abs. 1 lit. d DS-GVO) Lebenswichtige
					Interessen von Ihnen oder anderen Personen geschützt werden müssen. (vgl. Art. 6
					Abs. 1 lit. d DS-GVO) Zudem setzen wir ggf. Dienstleister ein, die für den
					Betrieb der Internetseite oder weitere Dienstleistungen zuständig sind. Hier
					kann es vorkommen, dass diese Dienstleister Kenntnis von Ihren personenbezogenen
					Daten erhalten. Wir treffen jedoch alle datenschutzrechtlich erforderlichen
					Maßnahmen um die sichere und zuverlässige Verarbeitung Ihrer Daten zu
					gewährleisten.
					...
					Webanalyse Newsletter Auf unserer Internetseite besteht die Möglichkeit einen
					Newsletter zu abonnieren. Welche personenbezogenen Daten bei der Bestellung des
					Newsletters an den für die Verarbeitung Verantwortlichen übermittelt werden,
					ergibt sich aus der hierzu verwendeten Eingabemaske. Der Newsletter kann
					grundsätzlich nur dann empfangen werden, wenn (1) die betroffene Person über
					eine gültige E-Mail-Adresse verfügt und (2) die betroffene Person sich für den
					Newsletterversand registriert. Zudem wird erstmalig für den Newsletterversand
					eingetragene E-Mail-Adresse aus rechtlichen Gründen eine Bestätigungsmail im
					...
					Newsletters autorisiert hat. Bei der Anmeldung zum Newsletter speichern wir
					ferner die vom Internet-Service-Provider (ISP) vergebene IP-Adresse des von der
					betroffenen Person zum Zeitpunkt der Anmeldung verwendeten Computersystems sowie
					das Datum und die Uhrzeit der Anmeldung. Die Erhebung dieser Daten ist
					...
					der rechtlichen Absicherung des für die Verarbeitung Verantwortlichen. Die im
					...
					der Veränderung der technischen Gegebenheiten der Fall sein könnte. Der Versand
					der Newsletter erfolgt mittels des Versanddienstleister „MailChimp“, Rocket
					Science Group, LLC, 675 Ponce De Leon Ave NE #5000, Atlanta, GA 30308, USA. Die
					...
					Daten an Dritte weiterzugeben. Das Abonnement unseres Newsletters kann durch die
					betroffene Person jederzeit gekündigt werden. Die Einwilligung in die
					...
					Diese Datenschutzerklärung ist aktuell gültig und hat den Stand Juli 2021. Um
					den Schutz Ihrer Daten auch zukünftig bestmöglich gewährleisten zu können
					behalten wir uns vor, diese Datenschutzerklärung anzupassen, damit sie stets den
					...
					Services. Für Ihren erneuten Besuch gilt dann die neue Datenschutzerklärung. Wir
					empfehlen Ihnen daher, unsere Informationen und Hinweise zur Datenverarbeitung
					regelmäßig erneut zur Kenntnis zu nehmen.
				</div>
				<HomeFooter />
			</IonContent>
		</IonApp>
