	...
	<IonApp>
		...
		<IonContent>
			<div className="privacy">
				...
				durch Dritte ist nicht möglich. Rechtsgrundlage der Datenverarbeitung Um Ihnen
				unsere Internetseite und die damit verbundenen Dienstleistungen anbieten zu können,
				müssen wir personenbezogenen Daten verarbeiten. Diese Verarbeitung basiert auf
				folgender Rechtsgrundlage: Art. 6 Abs. 1 lit. a DS-GVO dient als Rechtsgrundlage für
				Verarbeitungsvorgänge, bei denen eine Einwilligung für den spezifischen
				Verwendungszweck eingeholt wird. Handelt es sich bei den zu verarbeitenden Daten um
				personenbezogene Daten die für die Erfüllung eines Vertrags erforderlich sind, bei
				dem Sie selbst Vertragspartei sind, beruht die Verarbeitung dieser Daten auf Art. 6
				Abs. 1 lit. b DS-GVO. Dies ist z.B. bei der Lieferung von Waren oder der Erbringung
				sonstiger Leistungen notwendig. Gleiches gilt für Verarbeitungsvorgänge die für die
				Durchführung vorvertraglicher Maßnahmen benötigt werden, z.B. bei Produktanfragen.
				Die Verarbeitung von personenbezogenen Daten kann auch aufgrund rechtlicher
				Verpflichtungen erforderlich werden, z.B. zur Erfüllung von steuerlichen Pflichten.
				Diese Art der Datenverarbeitung beruht auf Art. 6 Abs. 1 lit. c DS-GVO In
				Ausnahmefällen kann die Verarbeitung von personenbezogenen Daten notwendig werden,
				um lebenswichtige Interessen der betroffenen Person oder anderer natürlicher
				Personen zu wahren. Dies ist z.B. bei Unfällen im Betrieb notwendig, wenn
				medizinische Hilfe hinzugezogen wird. Die rechtliche Grundlage ergibt sich aus Art.
				6 Abs. 1 lit. d DS-GVO Personenbezogene Daten können auch auf Basis einer
				Interessenabwägung verarbeitet werden. Dies ist gemäß Art. 6 Abs. 1 lit. f DS-GVO
				dann möglich, wenn ein berechtigtes Interesse seitens unseres Unternehmens oder
				eines Dritten besteht und die Datenverarbeitung dafür zwingend erforderlich ist.
				Dabei darf das berechtigte Interesse die Grundrechte und Grundfreiheiten des
				Betroffenen nicht überwiegen. Widerruf Ihrer Einwilligung zur Datenverarbeitung
				...
				Newsletters an den für die Verarbeitung Verantwortlichen übermittelt werden, ergibt
				sich aus der hierzu verwendeten Eingabemaske. Der Newsletter kann grundsätzlich nur
				dann empfangen werden, wenn (1) die betroffene Person über eine gültige
				E-Mail-Adresse verfügt und (2) die betroffene Person sich für den Newsletterversand
				registriert. Zudem wird erstmalig für den Newsletterversand eingetragene
				E-Mail-Adresse aus rechtlichen Gründen eine Bestätigungsmail im
				Double-Opt-In-Verfahren versendet. Diese Bestätigungsmail dient der Überprüfung, ob
				der Inhaber der E-Mail-Adresse als betroffene Person den Empfang des Newsletters
				autorisiert hat. Bei der Anmeldung zum Newsletter speichern wir ferner die vom
				...
				Verarbeitung Verantwortlichen. Die im Rahmen einer Anmeldung zum Newsletter
				...
				informiert werden, sofern dies für den Betrieb des Newsletter-Dienstes oder eine
				diesbezügliche Registrierung erforderlich ist, wie dies im Falle von Änderungen am
				Newsletterangebot oder bei der Veränderung der technischen Gegebenheiten der Fall
				sein könnte. Der Versand der Newsletter erfolgt mittels des Versanddienstleister
				„MailChimp“, Rocket Science Group, LLC, 675 Ponce De Leon Ave NE #5000, Atlanta, GA
				30308, USA. Die Datenschutzbestimmungen des Versanddienstleisters können Sie hier
				einsehen:{' '}
				<a href="https://mailchimp.com/legal/privacy/">
					https://mailchimp.com/legal/privacy/
				</a>
				. The Rocket Science Group LLC d/b/a MailChimp ist unter dem Privacy-Shield-Abkommen
				...
				Art. 6 Abs. 1 lit. f DSGVO und eines Auftragsverarbeitungsvertrages gem. Art. 28
				Abs. 3 S. 1 DSGVO eingesetzt. Der Versanddienstleister kann die Daten der Empfänger
				...
				Versandes und der Darstellung der Newsletter oder für statistische Zwecke verwenden.
				Der Versanddienstleister nutzt die Daten unserer Newsletterempfänger jedoch nicht,
				um diese selbst anzuschreiben oder um die Daten an Dritte weiterzugeben. Das
				Abonnement unseres Newsletters kann durch die betroffene Person jederzeit gekündigt
				...
				Newsletter ein entsprechender Link. Ferner besteht die Möglichkeit, sich jederzeit
				auch direkt auf der Internetseite des für die Verarbeitung Verantwortlichen vom
				Newsletterversand abzumelden oder dies dem für die Verarbeitung Verantwortlichen auf
				andere Weise mitzuteilen.
				<h2>5. Änderungen der Datenschutzbestimmungen</h2>
				Diese Datenschutzerklärung ist aktuell gültig und hat den Stand Juli 2021. Um den
