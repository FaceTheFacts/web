...
const Profile: React.FC<ProfileProps> = ({ candidate, profileId }: ProfileProps) => {
	...
	const cvData= {
		...
		{
			"Raw": "2012/2017 Studium der Rechtswissenschaften an der Ernst-Moritz-Arndt Universität Greifswald (Studienabschluss mit Prädikat)",
			"Label": "Studium der Rechtswissenschaften an der Ernst-Moritz-Arndt Universität Greifswald (Studienabschluss mit Prädikat)",
			"Date": "2012/2017"
		},
		{
			"Raw": "2017 wissenschaftlicher Mitarbeiter an der Ernst-Moritz-Arndt-Universität Greifswald und Mitarbeiter einer Wirtschaftskanzlei in Berlin",
			"Label": "wissenschaftlicher Mitarbeiter an der Ernst-Moritz-Arndt-Universität Greifswald und Mitarbeiter einer Wirtschaftskanzlei in Berlin",
			"Date": "2017"
		},
		{
		...
		{
			"Raw": "Mitglied des Bundestages seit Oktober 2017 (Mitglied im Innenausschuss und im Europaausschuss",
			"Label": "Mitglied des Bundestages  (Mitglied im Innenausschuss und im Europaausschuss",
			"Date": "seit Oktober 2017"
		},
		{
			"Raw": "Seit 2018 Vorstandsmitglied im Parlamentskreis Mittelstand der CDU/CSU-Bundestagsfraktion",
			"Label": "Vorstandsmitglied im Parlamentskreis Mittelstand der CDU/CSU-Bundestagsfraktion",
			"Date": "seit 2018"
		}]
		}
	}
