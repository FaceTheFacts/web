export const amthor = {
	...
	image:
		new URL('https://www.abgeordnetenwatch.de/sites/default/files/styles/opengraph_image/public/politicians-profile-pictures/philipp_amthor.jpg?itok=_-cUhevr'),
	party: 'CDU/CSU',
	sideJobs: [
		{
            ...
            articles: [
                {
                    ...
                    image:
                        new URL('https://cdn.prod.www.spiegel.de/images/e4f16506-cc40-4023-a068-8c33a57bf098_w948_r1.77_fpx39.81_fpy49.98.jpg'),
                    url:
                        new URL('https://www.spiegel.de/wirtschaft/unternehmen/affaere-um-philipp-amthor-geschaeftsfuehrer-von-augustus-intelligence-laesst-amt-ruhen-a-6577f286-2dc0-4f74-a08c-a2536e86a87d'),
                    publisher: 'spiegel',
                },
                {
                    label:
                    ...
                    image:
                        new URL('https://www.handelsblatt.com/images/philipp-amthor/25914394/3-format2020.jpg'),
                    url:
                        new URL('https://www.handelsblatt.com/politik/deutschland/augustus-intelligence-fuer-diese-merkwuerdige-firma-hat-sich-philipp-amthor-engagiert/25914246.html?ticket=ST-630502-PMl5Lfyb2kItmkRSq1QJ-ap6'),
                    publisher: 'handelsblatt',
                },
                {
                    label: 'Verfahren gegen Philipp Amthor eingestellt',
                    image:
                        new URL('https://img.zeit.de/politik/deutschland/2020-07/philipp-amthor-staatsanwaltschaft-lobbyismus-bestechlichkeit-ermittlungen-eingestellt-bild/wide__820x461__desktop'),
                    url:
                        new URL('https://www.zeit.de/politik/deutschland/2020-07/philipp-amthor-lobby-affaere-staatsanwaltschaft-bestechlichkeit-ermittlungen-eingestellt'),
        ...
        },
        {
            ...
            articles: [
                ...
                },
                {
                    ...
                    image:
                        new URL('https://www.tagesspiegel.de/images/philipp-amthor-mdb-cdu-bundestagsabgeordneter-aus-mecklenburg-vorpommern-fotografiert-im-tunnel-zwischen-reichstag-und-paul-loebe-haus-in-berlin-foto-mike-wolff/25035974/1-format43.jpg'),
                    url:
                        new URL('https://www.tagesspiegel.de/politik/amthor-bleibt-video-schuldig-cdu-antwort-an-youtuber-rezo-doch-nicht-im-netz/25035964.html'),
                    publisher: 'tagesspiegel',
                },
                {
                    label: 'Amthor verrät Satz aus Video Antwort',
                    image:
                        new URL('https://www.zdf.de/assets/philipp-amthor-106~1280x720?cb=1559819231142'),
                    url:
                        new URL('https://www.zdf.de/nachrichten/heute-sendungen/videos/philipp-amthor-verraet-ersten-satz-aus-antwort-video-an-rezo-bei-markus-lanz-100.html'),
                    publisher: 'zdf',
                },
                {
                    label: 'CDU-Mann Amthor verblüfft mit Blödel-Auftritt',
                    image:
                        new URL('https://bilder.t-online.de/b/88/06/90/98/id_88069098/tid_da/der-27-jaehrige-bundestagsabgeordnete-philipp-amthor-galt-als-nachwuchshoffnung-der-cdu-.jpg'),
                    url:
                        new URL('https://www.bild.de/politik/inland/politik-inland/philipp-amthor-cdu-kuendigt-bei-markus-lanz-antwort-auf-rezo-video-an-aber-64827894.bild.html'),
                    publisher: 'bild',
                },
                {
                    label: 'CDU-Antwort an Rezo doch nicht im Netz',
                    image:
                        new URL('https://www.wz.de/imgs/39/6/7/6/2/2/5/8/7/tok_9493083746e31342f0314db3fd137b7f/w1900_h1052_x1985_y745_MDB_2195_116329216-965890a82ac6efee.jpg'),
                    url:
                        new URL('https://www.wz.de/politik/cdu-antwort-an-rezo-doch-nicht-im-netz-amthor-bleibt-video-schuldig_aid-45960339'),
